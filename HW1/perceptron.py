...
def prceptron(samples,t_arr,max_iter):
    ...
    plt.title("Train set error - perceptron")
    plt.xlabel("Epoch")
    plt.ylabel("error")
    plt.show()
    plt.plot(range(iterate + 1), error_valid)
    plt.title("Validation set error - perceptron")
    plt.xlabel("Epoch")
    plt.ylabel("error")
    plt.show()
    plt.plot(range(iterate + 1), mse_train)
    plt.title("Train set MSE- perceptron")
    plt.xlabel("Epoch")
    plt.ylabel("mse")
    plt.show()
    plt.plot(range(iterate + 1), mse_valid)
    plt.title("Validation set MSE - perceptron")
    plt.xlabel("Epoch")
    plt.ylabel("mse")
    plt.show()
